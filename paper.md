---
title: 'GENRE (GPU Elastic-Net REgression): A MATLAB Package for Massively Parallel Linear Regression with Elastic-Net Regularization'
tags:
  - MATLAB
  - GPU computing
...
# Summary
GENRE (GPU Elastic-Net REgression) is a MATLAB (MathWorks, Natick, MA) package that allows for many instances of linear
...
achieve computational speedup. This is due to the fact that modern GPUs consist of thousands of computational cores
...
[@chen_juttukonda_lee_su_espinoza_lin_shen_lulash_an_2014]. Now, by using GENRE, the models in each of the aforementioned examples can be computed in parallel.
