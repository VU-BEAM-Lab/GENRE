...
[@chen_juttukonda_lee_su_espinoza_lin_shen_lulash_an_2014]. Now, by using GEN, the models in each of the aforementioned examples can be computed in parallel to achieve computational acceleration.
