...
[@chen_juttukonda_lee_su_espinoza_lin_shen_lulash_an_2014]. Now, by using GEN, the computation of these models can be parallelized and therefore accelerated.
