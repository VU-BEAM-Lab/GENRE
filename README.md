...
3. As previously stated, each model fit is supplied a lambda value in GEN, so the coefficients are not calculated for a path of lambda
   ...
   values will be computed in parallel on the GPU.
