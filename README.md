...
In this equation, $N$ represents the number of observations, P represents the number of predictors, X is the model matrix, and y is the observed data to which the model is being fit.
