...
In this equation, N represents the number of observations, P represents the number of predictors, X is the model matrix containing P predictors with N observations each, and y is the observed data of length N to which the model matrix is being fit.
