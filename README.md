...
Once all of the above steps are completed, you should check to see that MATLAB recognizes your GPU card. To do so, go to the command prompt and type 
'''Matlab
gpuDevice
'''
the code should be able to be compiled. Go to the MATLAB directory that contains the repository folders and add them to your MATLAB path. The next step is to type the compilation commands into the MATLAB command prompt. On windows
