...
\begin{tabular}[h]{| c | c | c | c | c |} 
\hline
\multicolumn{5}{|c|}{\textbf{TABLE II: Benchmark Times (s)}} \\
\hline
\textbf{GENRE DP} & \textbf{GENRE DP SMEM} & \textbf{GENRE SP} & \textbf{GENRE SP SMEM} & \textbf{glmnet} \\
\hline
